var FwbqPage = function() {
	...
	var init = function(type){
		$("#data-table").html("");
		var url = type == "all" ? "/api/fwbq/all": "/api/fwbq/different";
		$.ajax({
			url: url,
			method: 'GET',
			success: function(res) {
				$.each(res, function(idx, obj) {
					...
					html += "<td style=\"text-align:center\">" + obj.fwbqid + "</td>";
					html += "<td style=\"text-align:center\">" + obj.fwbqmc + "</td>";
