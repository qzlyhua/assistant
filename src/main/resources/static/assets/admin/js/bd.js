		...
		$.ajax({
			...
			success: function(res) {
				$.each(res, function(idx, obj) {
					...
					html += "<td style=\"text-align:center\">" + obj.bdbh + "</td>";
					html += "<td style=\"text-align:center\">" + obj.bdmc +  "</td>";
					html += "<td style=\"text-align:center\">" + obj.yylx +  "</td>";
					html += "<td id = '" + idx + "-dev" + "' style=\"text-align:center\">" + genBtn('dev', obj.dev, obj.bdbh, idx+'-dev') + "</td>";
					html += "<td id = '" + idx + "-test" + "' style=\"text-align:center\">" + genBtn('test', obj.test, obj.bdbh, idx+'-test') + "</td>";
					html += "<td id = '" + idx + "-testtjd" + "' style=\"text-align:center\">" + genBtn('testtjd', obj.testtjd, obj.bdbh, idx+'-testtjd') + "</td>";
					html += "<td id = '" + idx + "-pro" + "' style=\"text-align:center\">" + genBtn('pro', obj.pro, obj.bdbh, idx+'-pro') + "</td>";
					html += "</tr>";
