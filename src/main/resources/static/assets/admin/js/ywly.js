		...
		$.ajax({
			...
			success: function(res) {
				$.each(res, function(idx, obj) {
					...
					html += "<td style=\"text-align:center\">" + obj.yylx + "</td>";
					html += "<td style=\"text-align:center\">" + obj.ywlyjb +  "</td>";
					html += "<td style=\"text-align:center\">" + obj.ywlymc +  "</td>";
					html += "<td id = '" + idx + "-dev" + "' style=\"text-align:center\">" + genBtn('dev', obj.dev, obj.ywlymc, idx+'-dev') + "</td>";
					html += "<td id = '" + idx + "-test" + "' style=\"text-align:center\">" + genBtn('test', obj.test, obj.ywlymc, idx+'-test') + "</td>";
					html += "<td id = '" + idx + "-testtjd" + "' style=\"text-align:center\">" + genBtn('testtjd', obj.testtjd, obj.ywlymc, idx+'-testtjd') + "</td>";
					html += "<td id = '" + idx + "-pro" + "' style=\"text-align:center\">" + genBtn('pro', obj.pro, obj.ywlymc, idx+'-pro') + "</td>";
					html += "</tr>";
